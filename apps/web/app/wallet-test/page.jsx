  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <div className="mb-10 text-center">
        <h1 className="text-3xl font-bold mb-3">Wallet Simulator</h1>
      ...
      {result.message && (
        <div className={`mb-8 p-4 rounded-lg flex items-start gap-3 border ${
          ...
          <div>
            ...
            {result.data && (
              <pre className="mt-2 text-xs bg-white/60 p-3 rounded overflow-x-auto">
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <input
            ...
            className="flex-grow px-4 py-3 rounded-lg border border-gray-200 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
          />
          <button
            onClick={handleCreate}
            disabled={loading !== null}
            className="flex items-center justify-center gap-2 bg-primary hover:bg-accent text-white px-6 py-3 rounded-lg font-medium transition-colors disabled:opacity-70"
          >
          ...
          <button
            ...
            disabled={loading !== null}
            className="flex items-center justify-center gap-2 bg-secondary text-primary hover:bg-teal-100 px-6 py-3 rounded-lg font-medium transition-colors disabled:opacity-70"
          >
